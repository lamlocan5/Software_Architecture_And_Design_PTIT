...
class ShipmentStatusUpdate(APIView):
    ...
    def patch(self, request, shipment_id):
        ...
        # Publish shipment_updated event asynchronously for notification-service
        try:
            from .event_broker import publish_event
            publish_event('shipment_updated', {
            ...
            print(f"[Shipping Service] Failed to publish shipment_updated event: {e}")
