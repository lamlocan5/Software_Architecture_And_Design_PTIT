...
from .views import gateway_health, proxy_to_customer, proxy_to_laptop, proxy_to_moblie, proxy_to_staff, proxy_to_advisor
...
urlpatterns = [
    ...
    re_path(r"^api/advisor/(?P<upstream_path>.*)$",  proxy_to_advisor),
]
